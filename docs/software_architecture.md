...
- **AI Processing (Intelligence Layer):** OpenAI GPT-4o Vision API acting as the forensic processing engine.
...
graph TD
    ...
    APIUpload -->|Base64 Images + Prompt| OpenAI[OpenAI GPT-4o Vision]
    OpenAI -.->|JSON Verdict| APIUpload
...
- **OpenAI:** Used strictly server-side to prevent API key exposure. File buffers are converted to Base64 in standard Node arrays before transmission.
